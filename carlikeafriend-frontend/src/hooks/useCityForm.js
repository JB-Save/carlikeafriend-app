...
export const useCityForm = (cityToEdit, onCitySaved) => {
    ...
    const submitCityData = async (data) => {
        ...
        try {
            ...
            const URL = cityToEdit
                ? `${API_CONFIG.CITIES}/${cityToEdit.id}`
                : API_CONFIG.CITIES;

            const method = cityToEdit ? 'PUT' : 'POST';
